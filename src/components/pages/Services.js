    ...
    q(".compile").forEach((imgframe) => {
      gsap.fromTo(
        ...
        { y: 60, opacity: 0 },
        {
          ...
          opacity: 1,
          duration: 2,
          scrollTrigger: { trigger: imgframe },
        }
      );
    });
  }, []);
      ...
      <section className="servicoContainer" ref={imgRef}>
        <div className="servico">
          <div className="compile">
            ...
            <div className="description">
              <p>
                A acupuntura é um método tradicional chinês voltado pra o alívio
                de dores e relaxamento. A inserção de de finas agulhas indolores
                na pele do paciente rebalanceiam a energia (qi) e estimulam o
                corpo a liberar suas químicas naturais para combater doenças ou
                sintomas.
              </p>
            </div>
          </div>
        ...
        <div className="servico">
          <div className="compile">
            ...
            <div className="description">
              <p>
                O termo Quiropraxia deriva de duas raízes gregas: "Quiro" (mãos)
                e "Praxis" (praticar), ou seja, "praticar com as mãos". A
                técnica lida com o diagnóstico, o tratamento e a prevenção de
                problemas no sistema neuro-músculo-esquelético, bem como seus
          ...
          <div className="compile">
            <div className="description">
              <p>
                ...
                lipoaspirações, que resultam na retenção de líquido. Mas também
                é muito indicada em casos de cirurgias de varizes, ortopédicas e
                outras em que o paciente passa dias de repouso ou ganha
          ...
          <div className="compile">
            <div className="description">
              <p>
                ...
                vezes por semana, e normalmente o tratamento deve ser contínuo,
                para ter a manutenção dos resultados.
              </p>
            </div>
            <div className="imgframe">
          ...
          <div className="compile">
            ...
            <div className="description">
              <p>
                ...
                retiradas do local armazenado, tais substâncias são eliminadas
